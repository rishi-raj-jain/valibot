...
- [Formisch](https://formisch.dev/): The headless, modular and type-safe form library for any framework
...
- [piying-view](https://github.com/piying-org/piying-view): Frontend Form Solution; Supports Angular, Vue, React, Solid, Svelte.
...
- [vscode-toolkit](https://github.com/wszgrcy/vscode-toolkit): Convert Valibot schemas to VSCode configuration formats with responsive read/write capabilities
