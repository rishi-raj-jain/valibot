...
// Generated by the `vite-font` plugin (see vite.config.ts): `preloads` are the self-hosted,
// content-hashed font files, `css` the `@font-face` rules plus the metric-matched fallbacks.
...
export const Head = component$(() => {
  ...
  return (
    <head>
      ...
      <style dangerouslySetInnerHTML={fontCss} />
